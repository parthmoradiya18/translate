...
class Frisian extends StatefulWidget {
  const Frisian({Key? key}) : super(key: key);

  @override
  State<Frisian> createState() => _FrisianState();
}

class _FrisianState extends State<Frisian> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController frisian = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'fy')
                        .then((s) {
                      setState(() {
                        frisian.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
