...
class Bhojpuri extends StatefulWidget {
  const Bhojpuri({Key? key}) : super(key: key);

  @override
  State<Bhojpuri> createState() => _BhojpuriState();
}

class _BhojpuriState extends State<Bhojpuri> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController bhojpuri = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'bho')
                        .then((s) {
                      setState(() {
                        bhojpuri.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
