...
class Bambara extends StatefulWidget {
  const Bambara({Key? key}) : super(key: key);

  @override
  State<Bambara> createState() => _BambaraState();
}

class _BambaraState extends State<Bambara> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController bambara = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'bm')
                        .then((s) {
                      setState(() {
                        bambara.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
