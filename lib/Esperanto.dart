...
class Esperanto extends StatefulWidget {
  const Esperanto({Key? key}) : super(key: key);

  @override
  State<Esperanto> createState() => _EsperantoState();
}

class _EsperantoState extends State<Esperanto> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController esperanto = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'eo')
                        .then((s) {
                      setState(() {
                        esperanto.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
