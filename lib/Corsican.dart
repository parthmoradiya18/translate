...
class Corsican extends StatefulWidget {
  const Corsican({Key? key}) : super(key: key);

  @override
  State<Corsican> createState() => _CorsicanState();
}

class _CorsicanState extends State<Corsican> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController corsican = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'co')
                        .then((s) {
                      setState(() {
                        corsican.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
