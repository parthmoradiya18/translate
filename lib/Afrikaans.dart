...
class Afrikaans extends StatefulWidget {
  const Afrikaans({Key? key}) : super(key: key);

  @override
  State<Afrikaans> createState() => _AfrikaansState();
}

class _AfrikaansState extends State<Afrikaans> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController afrikaans = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'af')
                        .then((s) {
                      setState(() {
                        afrikaans.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
