...
class Armenian extends StatefulWidget {
  const Armenian({Key? key}) : super(key: key);

  @override
  State<Armenian> createState() => _ArmenianState();
}

class _ArmenianState extends State<Armenian> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController armenian = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'hy')
                        .then((s) {
                      setState(() {
                        armenian.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
