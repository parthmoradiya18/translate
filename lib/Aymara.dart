...
class Aymara extends StatefulWidget {
  const Aymara({Key? key}) : super(key: key);

  @override
  State<Aymara> createState() => _AymaraState();
}

class _AymaraState extends State<Aymara> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController aymara = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'ay')
                        .then((s) {
                      setState(() {
                        aymara.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
