...
class Dhivehi extends StatefulWidget {
  const Dhivehi({Key? key}) : super(key: key);

  @override
  State<Dhivehi> createState() => _DhivehiState();
}

class _DhivehiState extends State<Dhivehi> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController dhiveni = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'dv')
                        .then((s) {
                      setState(() {
                        dhiveni.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
