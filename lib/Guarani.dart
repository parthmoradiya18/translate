...
class Guarani extends StatefulWidget {
  const Guarani({Key? key}) : super(key: key);

  @override
  State<Guarani> createState() => _GuaraniState();
}

class _GuaraniState extends State<Guarani> {

  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController guarani = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'gn')
                        .then((s) {
                      setState(() {
                        guarani.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
