...
class Bulgarian extends StatefulWidget {
  const Bulgarian({Key? key}) : super(key: key);

  @override
  State<Bulgarian> createState() => _BulgarianState();
}

class _BulgarianState extends State<Bulgarian> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController bulgarian = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'bg')
                        .then((s) {
                      setState(() {
                        bulgarian.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
