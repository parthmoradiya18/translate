...
class Albanian extends StatefulWidget {
  const Albanian({Key? key}) : super(key: key);

  @override
  State<Albanian> createState() => _AlbanianState();
}

class _AlbanianState extends State<Albanian> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController albanian = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'sq')
                        .then((s) {
                      setState(() {
                        albanian.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
