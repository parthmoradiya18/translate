...
class Dutch extends StatefulWidget {
  const Dutch({Key? key}) : super(key: key);

  @override
  State<Dutch> createState() => _DutchState();
}

class _DutchState extends State<Dutch> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController dutch = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'nl')
                        .then((s) {
                      setState(() {
                        dutch.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
