...
class Georgian extends StatefulWidget {
  const Georgian({Key? key}) : super(key: key);

  @override
  State<Georgian> createState() => _GeorgianState();
}

class _GeorgianState extends State<Georgian> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController georgian = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'ka')
                        .then((s) {
                      setState(() {
                        georgian.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
