...
class Catalan extends StatefulWidget {
  const Catalan({Key? key}) : super(key: key);

  @override
  State<Catalan> createState() => _CatalanState();
}

class _CatalanState extends State<Catalan> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController catalan = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'ca')
                        .then((s) {
                      setState(() {
                        catalan.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
