...
class Sanskrit extends StatefulWidget {
  const Sanskrit({Key? key}) : super(key: key);

  @override
  State<Sanskrit> createState() => _SanskritState();
}

class _SanskritState extends State<Sanskrit> {
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'sa')
                        .then((s) {
                      setState(() {
                        sanskrit.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
