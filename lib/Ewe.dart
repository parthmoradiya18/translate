...
class Ewe extends StatefulWidget {
  const Ewe({Key? key}) : super(key: key);

  @override
  State<Ewe> createState() => _EweState();
}

class _EweState extends State<Ewe> {
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'ee')
                        .then((s) {
                      setState(() {
                        ewe.text = s.toString();
                      });
