...
class Belarusian extends StatefulWidget {
  const Belarusian({Key? key}) : super(key: key);

  @override
  State<Belarusian> createState() => _BelarusianState();
}

class _BelarusianState extends State<Belarusian> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController belarusian = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'be')
                        .then((s) {
                      setState(() {
                        belarusian.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
