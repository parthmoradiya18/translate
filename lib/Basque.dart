...
class Basque extends StatefulWidget {
  const Basque({Key? key}) : super(key: key);

  @override
  State<Basque> createState() => _BasqueState();
}

class _BasqueState extends State<Basque> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController basque = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'eu')
                        .then((s) {
                      setState(() {
                        basque.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
