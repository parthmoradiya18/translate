...
class Croatian extends StatefulWidget {
  const Croatian({Key? key}) : super(key: key);

  @override
  State<Croatian> createState() => _CroatianState();
}

class _CroatianState extends State<Croatian> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController croatian = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'hr')
                        .then((s) {
                      setState(() {
                        croatian.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
