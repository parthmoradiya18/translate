...
class Dogri extends StatefulWidget {
  const Dogri({Key? key}) : super(key: key);

  @override
  State<Dogri> createState() => _DogriState();
}

class _DogriState extends State<Dogri> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController Dogri = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'doi')
                        .then((s) {
                      setState(() {
                        Dogri.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
