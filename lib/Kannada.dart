...
class Kannada extends StatefulWidget {
  const Kannada({Key? key}) : super(key: key);
...
class _KannadaState extends State<Kannada> {
  ...
  TextEditingController kannada = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'kn')
                        .then((s) {
                      setState(() {
                        kannada.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
            ...
            Padding(
              ...
              child: SizedBox(
                height: 50,
                child: TextField(
                  style: TextStyle(wordSpacing: 0.5, letterSpacing: 1),
                  controller: kannada,
                  textCapitalization: TextCapitalization.sentences,
                  textAlign: TextAlign.center,
                  cursorColor: Colors.black,
