...
class Bosnian extends StatefulWidget {
  const Bosnian({Key? key}) : super(key: key);

  @override
  State<Bosnian> createState() => _BosnianState();
}

class _BosnianState extends State<Bosnian> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController bosnian = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'bs')
                        .then((s) {
                      setState(() {
                        bosnian.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
