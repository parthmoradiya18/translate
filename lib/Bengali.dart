...
class Bengali extends StatefulWidget {
  const Bengali({Key? key}) : super(key: key);

  @override
  State<Bengali> createState() => _BengaliState();
}

class _BengaliState extends State<Bengali> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController bengali = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'bn')
                        .then((s) {
                      setState(() {
                        bengali.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
