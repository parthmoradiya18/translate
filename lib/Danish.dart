...
class Danish extends StatefulWidget {
  const Danish({Key? key}) : super(key: key);

  @override
  State<Danish> createState() => _DanishState();
}

class _DanishState extends State<Danish> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController danish = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'da')
                        .then((s) {
                      setState(() {
                        danish.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
