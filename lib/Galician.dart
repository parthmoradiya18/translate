...
class Galician extends StatefulWidget {
  const Galician({Key? key}) : super(key: key);

  @override
  State<Galician> createState() => _GalicianState();
}

class _GalicianState extends State<Galician> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController galician = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'gl')
                        .then((s) {
                      setState(() {
                        galician.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
