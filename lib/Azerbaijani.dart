...
class Azerbaijani extends StatefulWidget {
  const Azerbaijani({Key? key}) : super(key: key);

  @override
  State<Azerbaijani> createState() => _AzerbaijaniState();
}

class _AzerbaijaniState extends State<Azerbaijani> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController azerbaijani = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'az')
                        .then((s) {
                      setState(() {
                        azerbaijani.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: TextField(style: TextStyle(wordSpacing: 0.5,letterSpacing: 1),
                  controller: azerbaijani,
                  textCapitalization: TextCapitalization.sentences,
                  textAlign: TextAlign.center,
                  cursorColor: Colors.black,
                  decoration: const InputDecoration(
                    hintText: 'azerbaijani',
                    labelStyle: TextStyle(fontSize: 25),
                    focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.all(Radius.circular(5)),
