...
class Assamese extends StatefulWidget {
  const Assamese({Key? key}) : super(key: key);

  @override
  State<Assamese> createState() => _AssameseState();
}

class _AssameseState extends State<Assamese> {
  final translator = GoogleTranslator();
  TextEditingController eng = TextEditingController();
  TextEditingController assamese = TextEditingController();
          ...
          children: [
            ...
            Container(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    translator
                        .translate(eng.text, from: 'en', to: 'as')
                        .then((s) {
                      setState(() {
                        assamese.text = s.toString();
                      });
                    });
                  },
                  style: ButtonStyle(
